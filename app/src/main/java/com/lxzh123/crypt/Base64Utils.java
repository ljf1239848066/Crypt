...
public class Base64Utils {
    ...
    private static byte[] map3 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".getBytes();
    ...
    public static byte[] encode1(byte[] in) {
        int iLen = in.length;
        ...
        while (ip < iLen) {
            ...
            out[op++] = map3[o0];
            out[op++] = map3[o1];
            out[op] = op < oDataLen ? map3[o2] : 0x3d;
            op++;
            out[op] = op < oDataLen ? map3[o3] : 0x3d;
            op++;
        }
        return out;
    }
